...
namespace Business.Domain.Entities
{
    ...
    public class Faction
    {
        ...
        /// <param name="ownedResources">The resources owned by the faction.</param>
        private Faction(Guid id, string name, string description, ICollection<OwnedResource> ownedResources)
        {
            Id = id;
            Name = name;
        ...
        public static Faction Create(string name, string description, ICollection<OwnedResource> ownedResources)
        {
            return new Faction(Guid.NewGuid(), name, description, ownedResources);
        }
